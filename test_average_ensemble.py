...
def main():
    ...
    visualize.plot_confusion_matrix(targets, preds, class_labels, average_ensemble_plots, save = True, name_png = combo, fr='png', title=str(args.model_id) + '_' + combo)
    class_report =  classification_report(targets, preds, labels=class_labels, output_dict=True)
    results = {'accuracy': accuracy}
    eval_list = [results, class_report]
    with open(exp_path + '/' + str(args.model_id) + '_' + combo + '_' + 'average_ensemble_metrics.json', 'w+') as file:
